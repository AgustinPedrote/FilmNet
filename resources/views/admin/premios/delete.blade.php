{{-- Ventana modal para borrar al genero --}}
<div id="popup-modal{{ $genero }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-black  dark:text-gray-900">
                    ¿Seguro que deseas borrar esta genero?
                </h3>
                ...
                <form
                    ...
                    <button data-modal-toggle="popup-modal{{ $genero }}" type="submit"
                    ...
                    <button data-modal-toggle="popup-modal{{ $genero }}" type="button"
