                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 md:gap-8">
                        ...
                        <div>
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                <x-text-input id="titulo" class="block md:mt-1 w-full text-sm md:text-md" type="text"
                                    name="titulo" required autofocus autocomplete="titulo" />
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                class="block md:mb-2 md:mt-2 text-sm md:text-base font-bold text-gray-900 dark:text-white" />
                                <x-text-input id="titulo_original" class="block md:mt-1 w-full text-sm md:text-md" type="text"
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                class="block md:mb-2 md:mt-2 text-sm md:text-base font-bold text-gray-900 dark:text-white" />
                                <x-text-input id="year" class="block md:mt-1 w-full text-sm md:text-md" type="text"
                                    name="year" required autofocus autocomplete="year" />
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                class="block md:mb-2 md:mt-2 text-sm md:text-base font-bold text-gray-900 dark:text-white" />
                                <x-text-input id="duracion" class="block md:mt-1 w-full text-sm md:text-md" type="text"
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                class="block md:mb-2 md:mt-2 text-sm md:text-base font-bold text-gray-900 dark:text-white" />
                                <x-text-input id="pais" class="block md:mt-1 w-full text-sm md:text-md" type="text"
                                    name="pais" required autofocus autocomplete="pais" />
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                class="block md:mb-2 md:mt-2 text-sm md:text-base font-bold text-gray-900 dark:text-white" />
                                <x-text-input id="trailer" class="block md:mt-1 w-full text-sm md:text-md" type="text"
                                    name="trailer" autofocus autocomplete="trailer" />
                        ...
                        <div>
                            ...
                            <div class="mb-1 md:mb-4 p-1 md:p-2 border border-gray-300 rounded shadow-md">
                                ...
                                class="block md:mb-2 md:mt-2 text-sm md:text-base font-bold text-gray-900 dark:text-white" />
                                <input type="file" id="imagen" name="imagen" accept="image/*" class="block w-full text-sm md:text-md border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
