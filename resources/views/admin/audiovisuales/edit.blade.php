                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                         ...
                         <div>
                             ...
                             <div class="mb-4 p-2 border border-gray-300 rounded shadow-md">
                                 ...
                                 <x-text-input id="titulo" class="block mt-1 w-full text-md" type="text"
                             ...
                             <div class="mb-4 p-2 border border-gray-300 rounded shadow-md">
                                 ...
                                 <x-text-input id="titulo_original" class="block mt-1 w-full text-md" type="text"
                                     ...
                                     value="{{ $audiovisual->titulo_original }}" />
                             ...
                             <div class="mb-4 p-2 border border-gray-300 rounded shadow-md">
                                 <x-input-label for="year" :value="__('Año')"
                                     class="block mb-2 text-base font-bold text-gray-900 dark:text-white mt-2" />
                                 <x-text-input id="year" class="block mt-1 w-full text-md" type="text"
                             ...
                             <div class="mb-4 p-2 border border-gray-300 rounded shadow-md">
                                 <x-input-label for="pais" :value="__('País')"
                                     class="block mb-2 text-base font-bold text-gray-900 dark:text-white mt-2" />
                                 <x-text-input id="pais" class="block mt-1 w-full text-md" type="text"
