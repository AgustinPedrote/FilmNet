{{-- Ventana modal para borrar el audiovisual --}}
<div id="popup-modal{{ $audiovisual }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-black  dark:text-gray-900">
                    ¿Seguro que deseas borrar este audiovisual?
                </h3>

                <form action="{{ route('audiovisuales.borrar', $audiovisual) }}" method="POST" class="inline">
                    @method('DELETE')
                    @csrf

                    <button data-modal-toggle="popup-modal{{ $audiovisual }}" type="submit"
                    ...
                    <button data-modal-toggle="popup-modal{{ $audiovisual }}" type="button"
