{{-- Ventana modal para borrar al company --}}
<div id="popup-modal{{ $company }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-black  dark:text-gray-900">
                    ¿Seguro que deseas borrar esta companía?
                </h3>
                ...
                <form
                    ...
                    <button data-modal-toggle="popup-modal{{ $company }}" type="submit"
                    ...
                    <button data-modal-toggle="popup-modal{{ $company }}" type="button"
