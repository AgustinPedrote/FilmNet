{{-- Ventana modal para borrar al persona --}}
<div id="popup-modal{{ $persona }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-black  dark:text-gray-900">
                    ¿Seguro que deseas borrar esta persona?
                </h3>
                ...
                <form
                    ...
                    <button data-modal-toggle="popup-modal{{ $persona }}" type="submit"
                    ...
                    <button data-modal-toggle="popup-modal{{ $persona }}" type="button"
