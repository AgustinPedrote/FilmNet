 <!-- Ventana modal para editar un persona -->
 <div id="EditarModal{{ $persona }}" tabindex="-1" aria-hidden="true"
         ...
         <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
             ...
             <div class="flex items-start justify-between p-1 border-b rounded-t dark:border-gray-600 bg-blue-500">
                 <button type="button"
                     ...
                     data-modal-hide="EditarModal{{ $persona }}">
             ...
             <form action="{{ route('personas.update', $persona) }}" method="POST">
                 ...
                 <div class="p-6 space-y-6">
                     <div class="mb-6">
                         ...
                         <x-text-input id="nombre" class="block mt-1 w-full text-md" type="text" name="nombre"
                             value="{{ $persona->nombre }}" required autofocus autocomplete="nombre" />
                 ...
                 <div
                     ...
                     <!-- Botón "Cancelar" -->
                     <button data-modal-hide="EditarModal{{ $persona }}" type="button"
