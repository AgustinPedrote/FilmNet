                    ...
                    <tbody>
                        @foreach ($generos as $genero)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="py-4 px-6 text-center text-base w-1/2">{{ $genero->nombre }}</td>
                                <td class="px-6 text-center space-x-2">
                                    <a href="#" class="inline-block">
                                        <button
                                            ...
                                            data-modal-target="EditarModal{{ $genero }}"
                                            data-modal-toggle="EditarModal{{ $genero }}">
                                            Editar
                                        </button>
                                    </a>
                                    ...
                                    <button type="submit"
                                        ...
                                        data-modal-target="popup-modal{{ $genero }}"
                                        data-modal-toggle="popup-modal{{ $genero }}">
                                        Borrar
                                    </button>
                                    </form>
                                </td>
                            ...
                            <!-- Ventana modal para editar una genero -->
                            @include('admin.generos.edit')

                            <!-- Ventana modal para borrar una genero -->
                            @include('admin.generos.delete')
                        @endforeach
                    </tbody>
                </table>
            </div>
            ...
            <div class="flex justify-center mt-4">
                <a href="#" class="inline-block">
                    <button
                        ...
                        data-modal-target="InsertarModal{{ $genero }}"
                        data-modal-toggle="InsertarModal{{ $genero }}">
                        Insertar
                    </button>
                </a>

                <!-- Ventana modal para insertar una genero -->
                @include('admin.generos.create')
            </div>
