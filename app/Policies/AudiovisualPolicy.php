...
class AudiovisualPolicy
{
     ...
     */
    public function restore(User $user, Audiovisual $audiovisual): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, Audiovisual $audiovisual): bool
    {
        //
    }
}
