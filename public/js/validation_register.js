document.addEventListener("DOMContentLoaded", function () {
    ...
    function validateField(value, field, errorMessage) {
        ...
        // Comprueba si hay caracteres numéricos en el valor.
        if (/\d/.test(value)) {
            displayErrorMessage(
                field,
                "El campo no puede contener caracteres numéricos."
            );
            return false;
        }

        // Comprueba si hay al menos 3 caracteres alfabéticos.
        if (!/[a-zA-Z]{3,}/.test(value)) {
            displayErrorMessage(
                field,
                "Debe contener al menos 3 caracteres alfabéticos."
            );
            return false;
        }
        return true;
